...
| plantingContent （种植内容） |          | null        |         | varchar   | "玉米"         |
...
| rentTime（使用年限/月）   |          | not null    | 12      | int       | 12                 |
| applicantId（申请人）     | F        | not null    |         | int       | 参照教师表中的主键 |
| Status（申请状态）        |          | not null    |         | int       | 1或2或3...或7                  |
| startTime（开始交费时间） |          | null        |         | varchar   | "2016-11-20"       |
注意：土地申请表中的status字段一共有七种值供选择：1.交费中  2.申请中 3.未交费   4.锁定   5.申请失败   6.申请成功 7.失效（用户自行取消申请）
  <br/>
5.土地使用表(landRentInfo)

| Attribute name          | Key Type | Null/Unique | Default | Data Type | Sample Data        |
| ----------------------- | -------- | ----------- | ------- | --------- | ------------------ |
| lr_id（序号）           | P        | not null    |         | int       | 自增               |
| Lid（土地编号）         |          | not null    |         | int       |                    |
| rentTime（使用年限/月） |          | not null    |         |           |                    |
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            3.交费控制:  PayForController
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;          4.布局控制：LayoutController
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;           5.土地使用控制:LandUseController
&nbsp;&nbsp;&nbsp;&nbsp;Service层： 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.申请逻辑：LandApplyService
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  2.审核逻辑：CheckService
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 3.交费逻辑:  PayForService
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 4.布局控制：LandLayoutService
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 5.土地使用控制:LandRentService
&nbsp;&nbsp;&nbsp;&nbsp;Dao层：    
...
public interface LandRentInfoDao {
  ...
  [1]: ./images/all.jpg "all.jpg"
  [2]: ./images/design.jpg "design.jpg"
  [3]: ./images/apply.jpg "apply.jpg"
  [4]: ./images/interact.jpg "interact.jpg"
  [5]: ./images/check.jpg "check.jpg"
  [6]: ./images/check2.jpg "check2.jpg"
  [7]: ./images/phone.jpg "phone.jpg"
  [8]: ./images/use1.jpg "use1.jpg"
  [9]: ./images/use2.jpg "use2.jpg"