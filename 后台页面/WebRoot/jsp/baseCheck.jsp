					...
					<div class="col-lg-12">
                    	<!-- Nav tabs -->
                            <ul class="nav nav-tabs" role="tablist">
                              <li role="presentation" class="active"><a href="#home" role="tab" data-toggle="tab" id="Baseapply">申请</a></li>
                              <li role="presentation"><a href="#profile" role="tab" data-toggle="tab" id="Renewal">续期</a></li>
                            </ul>
                            ...
                            <!--申请表格-->
                              ...
                              <div role="tabpanel" class="tab-pane" id="profile">
                              		<form action="deleteLandRentInfo.do" method="post" id="deleteInfo">
                                        <table id="basecheck2" class="cell-border"
                                            cellspacing="0" width="100%">
                                            <thead>
                                                <tr bgcolor="#ECF1F5">
                                                    <td colspan="5">
                                                                    ...
                                                                    <li>
                                                                        <form action=".do" method="post"
                                                                            ...
                                                                            <table class="table">
                                                                                <tr>																		
                                                                                    <td>申报部门：
                                                                                      <select name="deptS" id="deptSh2" style="width:150px;">
								...
								<div class="modal-content" style="border:#3071a9 8px solid">
									...
									<div class="modal-body table-responsive">
										<table class="table">
											...
											<tr>
												<td>法定责任人 ：</td>
												<td colspan="3"><input type="text" id="dutyPerson2" disabled></td>
												
											</tr>
											<tr>
												<td>面向专业 ：</td>
												<td colspan="3"><div id="major_oriented2" style="border:#ccc 1px solid;height:80px;"></div></td>
												
											</tr>
											
											<tr>
												<td>通信地址 ：</td>
												<td colspan="3"><div id="linkAddress2" style="border:#ccc 1px solid;height:80px;"></div></td>
