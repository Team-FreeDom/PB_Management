				...
				<div class="page-header row">
					...
					<div class="row form">
						...
						<div class="col-lg-12 form-group">
							...
							<table id="statistictable" class="hover" cellspacing="0" width="100%">
                                    <thead>
                                       <tr bgcolor="#ECF1F5">
                                            <td colspan="18">
                                            	<ul id="dropdown_show">
                                                	<li><span class="icon-filter" id="screen">筛选</span>
                                                    	<ul class="hide_ul" style="display:none;">
                                                        	<li style="background:#d6dfe9;padding-left: 50px; padding-top: 10px;">
                                                          		<form>
                                                           		<div class="row">
                                                           			<div class="col-md-4">
                                                           				基地类型：
                                                                    <select  name="" id="baseCategory">
                                                                      <option value="" id="baseCategoryID" selected="selected">全部</option>
                                                                      
                                                                    </select> 
                                                           			</div>
                                                           			<div class="col-md-4">
                                                           				基地名字：
                                                                    <select  name="" id="baseName">
                                                                      <option value="" id="baseNameID" selected="selected">全部</option>
                                                                    </select>
                                                           			</div>
                                                           			<div class="col-md-4">
                                                           				年　　级：
                                                                    <select  name="" id="gradeClass">
					...
					<div class="row form">
						...
						<div class="col-lg-12 form-group">
							...
							<table id="statistictable2" class="hover" cellspacing="0" width="100%">
                                    <thead>
                                       <tr bgcolor="#ECF1F5">
                                            <td colspan="8">
                                            	<ul id="dropdown_show">
                                                    	...
                                                    	<ul class="hide_ul2" style="display:none;">
                                                        	<li style="background:#d6dfe9;padding-left: 50px; padding-top: 10px;">
                                                           		<div class="row">
                                                           			<div class="col-md-4">
                                                           				基地类型：
                                                                    <select  name="" id="baseCategory2">
                                                                      <option value="" id="baseCategory2ID">全部</option>
                                                                    </select> 
                                                           			</div>
                                                           			<div class="col-md-4">
                                                           				基地名字：
                                                                    <select  name="" id="baseName2">
                                                                      <option value="" id="baseName2ID">全部</option>
                                                                    </select>
                                                           			</div>
                                                           			<div class="col-md-4">
                                                           				年　　级：
                                                                    <select  name="" id="gradeClass2">
                                                               	...
                                                               	<div class="row" style="padding-top: 10px;">
                                                               		<div class="col-md-12">
																		  ...
																		  <div class="form-group">
																		    <label for="exampleInputName2">老　　师：</label>
																		    <input type="text" class="form-control" id="teacherName" value="全部">
																		  </div>
																		  <button type="button" id="selectName" class="btn btn-default">选择</button>
																		</form>                                                               			                                                             		                                                             			
                                                               		</div>
                                                               	</div>
                                                                	<div class="row" style="padding-top: 10px;">
      ...
      <div class="modal-body">
        ...
        <div class="row">
		  <div class="form-group col-md-6">
		    <label for="selectCollege">学院 ：</label>
		    <select type="text" class="form-control" id="selectCollege">
		    	<option id="selectCollegeID" value="">请选择学院</option>
		    </select>
		  </div> 
		  <div class="form-group col-md-6">
		    <label for="selectTeacher">老师 ：</label>
		    <select type="email" class="form-control" id="selectTeacher">
                                  	...
                                  	<form class="form-horizontal" role="form" id="PraForm">
                                          ...
                                          <table>
                                          	<tr>
                                                ...
                                                <td>
                                                    课程名称：<input readonly type="text" class="noborder" id="classname" value="农学实践(3)">
                                                </td>
                                                <td>
