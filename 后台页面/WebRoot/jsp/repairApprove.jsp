                                                	...
                                                	<li><span class="icon-filter">筛选</span>
                                                    	<ul class="hide_ul" style="display:none;">
                                                        	<li>
                                                            	...
                                                            	<tr>
                                                                	<td colspan="2">                                                                    基地名称：
                                                                    <select id="searchbase" style="width:150px;">
                                                                      <option value="" id="searchbaseid" selected>全部</option>                                                                     
                                                                    </select>  
                                                                    </td>
                                                                    <td colspan="2">
                                                                    	申报人:
                                                                        <select id="searchname"  style="width:150px;">
                                                	...
                                                	<li><span class="icon-filter" onClick="showsubmenu()">筛选</span>
                                                    	<ul class="hide_ul" style="display:none;">
                                                        	<li>
                                                            	...
                                                            	<tr>
                                                                	<td colspan="2">                                                                    基地名称：
                                                                    <select id="searchbase2" style="width:150px;">
                                                                      <option value="" id="searchbaseid2" selected>全部</option>                                                                     
                                                                    </select>  
                                                                    </td>
                                                                    <td colspan="2">                                                                    报修人：
                                                                    <select  id="searchname2"  style="width:150px;">
