			...
			<div class="main " style="min-height: 584px;">
				...
				<div class="page-header">
					...
					<div class="row form">
						...
						<div class="col-lg-12">
                                <table id="myrepair" class="cell-border" cellspacing="0" width="100%">
                                    <thead>
                        ...
                        <!--弹出框-->
                                    ...
                                    <div class="row">
                                    	<div class="col-md-12">
                                            <table class="table" style="border:none !important;">
                                                <tr>
                                                    <td>项目名称 ：</td>
                                                    <td><input id="projectname" type="text" class="form-control" value="" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td>基地名称 ： </td>
                                                    <td><input id="basename" type="text" class="form-control" value="" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td>报修人 ： </td>
                                                    <td><input id="name" type="text" class="form-control" value="" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td>申报时间 ： </td>
                                                   <td><input id="time" type="text"  class="form-control" value="" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td>预算金额 ： </td>
                                                   <td><input id="budget" type="text"  class="form-control" value="" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td>实际金额 ： </td>
                                                   <td><input id="actualmoney" type="text"  class="form-control" value="" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td>具体地址 ： </td>
                            ...
                            <div class="col-lg-12 form-group">
								<table id="myrepair2" class="cell-border" cellspacing="0" width="100%">
                                   <thead>
                                        <tr bgcolor="#ECF1F5">
                                            <td>历史记录</td>
