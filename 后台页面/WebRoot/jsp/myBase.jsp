		...
		<div class="row">
			...
			<div class="main " style="min-height: 584px;">
				...
				<div class="page-header row">
					...
					<div class="row form">
						<div class="col-lg-12">
                                <table id="mybasetable1" class="cell-border" cellspacing="0" width="100%">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete_data">撤回</button>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>申请失败</td>                                            
                                            <td>
                                            <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#rent_edit">查看</button>                                                                                        
                                            </td>
                                        </tr>                                       
                                    </tbody>
                                  </table>
					...
					<div class="modal fade" id="cancelOneModal" tabindex="-1"
                        ...
                        <!--弹出框-->
                        <div class="modal fade" id="fontTable" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  ...
                                  <div class="modal-body table-responsive">
                                  	<div class="row">
                                    	<div class="col-md-12">
											...
											<tr>
												<td>申请材料 ：</td>
												<td colspan="3" style="text-align:left;"><a id="resource" href="#" style="color:#3071a9;">点击查看</a></td>												
											</tr>
						...
						<div class="col-lg-12 form-group">
								<table id="mybasetable2" class="cell-border" cellspacing="0" width="100%">
                                   <thead>
                                        <tr bgcolor="#ECF1F5">
                                            <td>申请历史</td>
                                            <td colspan="8" ><!--筛选<span class="glyphicon glyphicon-sort-by-attributes"> </td>-->
                                                <ul id="dropdown_show">
                                        ...
                                        <tr>
                                           <td>耘园气象站</td>
                                            ...
                                            <td>1000</td>
                                             ...
                                             <td hidden>1</td>
                                            <td>申请失败</td> 
                                            <td><span class="icon-search" data-toggle="modal" data-target="#failapplication"></span></td>
                                        </tr>                                        
                                    </tbody>
                                  </table>
						</div>
