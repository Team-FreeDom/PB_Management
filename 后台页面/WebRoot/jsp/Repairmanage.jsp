                                    ...
                                    <div class="row">
                                    	<div class="col-md-12">
                                            ...
                                            <table class="table" style="border:none !important;">
                                                ...
                                                <tr>
                                                    <td>报修人 ： </td>
                                                    <td><input type="text" class="form-control" id="Ename"  disabled/></td>
                                                </tr>
                                                <tr>
                                                    <td>申报时间 ： </td>
                                                   <td><input type="text"  class="form-control" id="Etime"  disabled/></td>
                                                </tr>
                                                <tr>
                                                    <td>预算金额 ： </td>
                                                   <td><input type="text"  class="form-control" id="Ebudget"  disabled/></td>
                                                </tr>
                                               <tr>
                                                    <td>实际金额 ： </td>
                                                   <td><input type="text"  class="form-control" id="Emoney"  disabled/></td>
                                                </tr>
                                                <tr>
                                                    <td>具体位置 ： </td>
                                                ...
                                                <tr id="resourcetr">
                                                	<td>材料查看 ： </td>
                                                    <td><a href="" id="Elink" style="color:#00C; text-decoration:underline">点击查看</a></td>
                                                </tr>                                                
                                            </table>
                                            </form>
                                    	</div>
