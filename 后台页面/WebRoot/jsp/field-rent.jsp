                                                                                ...
                                                                                <div class="panel-body text-center">
                                                                                    ...
                                                                                    <li class="menuItem nav-parent">
                                                                                        ...
                                                                                        <ul class="nav nav-children">
                                                                                            ...
                                                                                            <li>
                                                                                                <a href="land_modle.jsp">
                                                                                                    <span class="text">
                                                                                                        土地布局设置</span>
                                                                                                </a>
                                                                                            </li>
                                                                                            <li>
                                                                                                <a href="fieldRent_maintain.jsp">
                                                                                                    <span class="text">
                                                                                                        土地租赁维护</span>
                                                                                                </a>
                                                                                            </li>
                                                                    ...
                                                                    <div class="row">
                                                                      <div class="col-md-4">
                                                                        <div class="btn-group" style="padding:0px 0px 5px 20px;">
                                                                            ...
                                                                            <a class="btn btn-default" id="girdout">
                                                                                        ...
                                                                                        <form class="form-horizontal" role="form">
                                                                                            <fieldset disabled>
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="col-sm-6">
                                                                                                        <input type="text" id="tudi_id" class="form-control"></div>
                                                                                                    </div>
                                                                                                </fieldset>
                                                                                                <fieldset disabled>
                                                                                                    <div class="form-group">
                                                                                                    ...
                                                                                                    <fieldset disabled>
                                                                                                        <div class="form-group">
                                                                                                            ...
                                                                                                            <div class="col-sm-6">
                                                                                                                <input type="text" class="form-control" id="tudi_college"></div>
                                                                                                            </div>
                                                                                                        </fieldset>
                                                                                                        <fieldset disabled>
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <div class="col-sm-6">
                                                                                                                    <input type="text" class="form-control" id="tudi_plantingContent"></div>
                                                                                                                </div>
                                                                                                            </fieldset>
                                                                                                            <fieldset disabled>
                                                                                                                <div class="form-group">
                                                                                                                    ...
                                                                                                                    <div class="col-sm-6">
                                                                                                                        <input type="text" class="form-control" id="tudi_landArea"></div>
                                                                                                                    </div>
                                                                                                                </fieldset>
                                                                                                                <fieldset disabled>
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-sm-6">
                                                                                                                            <input type="text" class="form-control" id="tudi_buildingArea" placeholder="单位：平方"></div>
                                                                                                                        </div>
                                                                                                                    </fieldset>
                                                                                                                    <fieldset disabled>
                                                                                                                        <div class="form-group">
                                                                                                                            ...
                                                                                                                            <div class="col-sm-6">
                                                                                                                                <input type="text" class="form-control" id="tudi_Afford" placeholder="人数"></div>
                                                                                                                            </div>
                                                                                                                        </fieldset>
                                                                                                                        ...
                                                                                                                        <div class="form-group">
                                                                                                                            <div class="col-sm-9" onclick="displayImg()" data-toggle="modal" data-target="#myModal">
                                                                                                                                <a href="#">
                                                                                                                                    <img id="imghead" class="bk-img-60 specialOne" border=0 src="" alt=""></a>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                    ...
                                                                                                    <div class="modal-body">
                                                                                                        ...
                                                                                                        <div class="text-center" style="margin-top:20px;">
                                                                                                            <form class="form-inline " role="form">
                                                                                                                ...
                                                                                                                <div class="form-group">
                                                                                                                    <label>开始日期：</label>
                                                                                                                    <input class="form-control" type="text" value='2016-2-3' id="stime" disabled></div>
                                                                                                                    <div class="form-group">
                                                                                                                        <label>结束日期：</label>
                                                                                                                        <input type="text" class="form-control" id="etime" value='2017-2-3' disabled></div>
                                                                                                                    </form>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="modal-footer">
