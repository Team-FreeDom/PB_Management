...
public interface MaintenanceDao {
	...
	/*
	 ...
	 函数功能：获取该用户实习基地数据
	 */
    public MaintenanceList maintenance(int pageindex, int size,String order,String orderDir,String searchValue,String college);
    ...
    /*
	 ...
	 函数功能：根据条件刷选获取实习基地数据
	  */
    public MaintenanceList getshaiBaseInfo(int basetype,String dept,int star,int pageindex, int size,String order,String orderDir,String searchValue);
