...
public class LandApplyController {
	...
	public String submitLandApply(HttpServletRequest request,
		...
		int flag = landApplyServiceImpl.submitLandApply(userid, lidList, str,
				info_str);
	...
	public String selfApply(HttpServletRequest request,
		...
		ApplyList al = landApplyServiceImpl.getselfApply(applicantId, bname,
				desc, page, length);
	...
	public String myRentFont(HttpServletRequest request,
		...
		ApplyList al = landApplyServiceImpl.myRentFont1(applicantId, page,
				length);
	...
	public String exportFile(HttpServletRequest request,
		 ...
		 * "file/" + fileName);
		 */
		String fullFileName = ExcelReport.getWebRootUrl(request, "/upload/")
				+ fileName;
	...
	/*
	 * @RequestMapping("/unionSelect.do") public String
	 * unionSelect(HttpServletRequest request, HttpServletResponse response,
	 * ModelMap map) throws IOException { System.out.println("调用了吗"); String
	 * applicantId = "201440509";
	 * 
	 * String bname = request.getParameter("bname"); String startTime =
	 * request.getParameter("startTime"); String endTime =
	 * request.getParameter("endTime"); String lid =
	 ...
	 * response.setContentType("text/html;charset=UTF-8");
	 * 
	 * try { response.getWriter().print(getObj.toString()); } catch (IOException
	...
	public String updateLayout_Info(HttpServletRequest request,
		...
		if (tag == 0) {
			...
			flagStr = landApplyServiceImpl.updateLayInfo(landinfoStr,
					layoutStr, bid);
		}
	...
	public String updateLandApplyDate(HttpServletRequest request,
		...
		Startplan sp = new Startplan("zl", "土地租赁", planstime, planetime,
				rentstime, rentetime, limitday);
