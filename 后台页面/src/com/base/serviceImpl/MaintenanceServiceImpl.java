...
public class MaintenanceServiceImpl implements MaintenanceService {
	...
	public String updateBaseInfo(String baseid, String basenamed,
	   ...
	   String message= maintenancedao.updateBaseInfo(baseid,basenamed,basetyped,landaread,buildingaread,undertakeCountd,userphoned,usernamed,personDuty, linkAddressd,adddate,star,collegenamed,collegephoned,cooperativeUnit,majorString,tag,setdated);
	   return message;
