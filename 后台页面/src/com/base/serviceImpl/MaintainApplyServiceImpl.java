...
public class MaintainApplyServiceImpl implements MaintainApplyService {
    ...
    public MaintainList query_maintainapply(int offsets, int page, int order,
	...
	MaintainList list = maintainapplydao.query_maintainapply(offsets, page,
		column, str1, str2);
	return list;
    }
	...
	String message=maintainapplydao.delete_maintainapply(str);
	return message;
    }
